        ...
        <div className="flex flex-col justify-between w-full p-12 xl:p-16">
          ...
          <div className="max-w-md">
            <blockquote className="relative">
              <svg className="absolute -top-2 -left-2 w-8 h-8 text-zinc-700 opacity-50" fill="currentColor" viewBox="0 0 32 32">
                <path d="M9.352 4C4.456 7.456 1 13.12 1 19.36c0 5.088 3.072 8.064 6.624 8.064 3.36 0 5.856-2.688 5.856-5.856 0-3.168-2.208-5.472-5.088-5.472-.576 0-1.344.096-1.536.192.48-3.264 3.552-7.104 6.624-9.024L9.352 4zm16.512 0c-4.8 3.456-8.256 9.12-8.256 15.36 0 5.088 3.072 8.064 6.624 8.064 3.264 0 5.856-2.688 5.856-5.856 0-3.168-2.304-5.472-5.184-5.472-.576 0-1.248.096-1.44.192.48-3.264 3.456-7.104 6.528-9.024L25.864 4z" />
              </svg>
              <p className="text-xl text-white font-light leading-relaxed mb-6 relative z-10">
                ShopRewards transformed how we manage loyalty programs across our retail network. Customer engagement increased by 40% in just three months.
              </p>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-zinc-800 border border-zinc-700 flex items-center justify-center text-zinc-400 text-sm font-medium">
                  LS
                </div>
                <div>
                  <div className="text-white text-sm font-medium">Lalatendu Swain</div>
                  <div className="text-zinc-500 text-xs">Retail Chain Owner</div>
                </div>
              </div>
            </blockquote>
          </div>
